using HostelMealManagement.Core.Entities.Auth;
using HostelMealManagement.Core.Entities.BaseEntities;
using HostelMealManagement.Core.Entities.EntityLogs;
using HostelMealManagement.Infrastructure.Extensions;
...
namespace HostelMealManagement.Infrastructure.DatabaseContext;
